# Name: Jay Williams
# Program Purpose: This program finds a random number for our C.E. Project topic using a Python LIST
#   "A" means the topic is available
#   "B" means the topic is unavailable

import random
topics = []     #create n empty LIST to hold the topic codes
TOTAL_TOPICS = 4 #test this program with 5 topics
