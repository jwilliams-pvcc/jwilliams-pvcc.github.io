# Name: Jay Williams
# Program Purpose:  This program computes college tuition & fees based on number of credits
...
def display_results():
    ...
    print("Total Tuition & Fees$" + format(totalowed, '10,.2f'))
    print(line)
    print("Scholarship         $" + format(scholarshipamt,'10,.2f'))
    print(line)
    print("Balance             $" + format(balance, '10,.2f'))
    print(line2)
